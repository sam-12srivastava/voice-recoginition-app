...
def play_media(name):
   ...
   webbrowser.open(f"https://www.youtube.com/results?search_query={name}")def get_weather(city):
    api_key = "720e50349255afc8cd6d50910d6f1a50"  # Replace with your OpenWeatherMap API key
